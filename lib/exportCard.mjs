...
// URL leggibile: via la coda di tracking, tieni host + percorso (vedi public/app.js)
const prettyUrl = (u) => {
  try { const x = new URL(u); return x.host + (x.pathname === "/" ? "" : x.pathname.replace(/\/$/, "")); }
...
function cardHtml(d) {
  ...
  *{margin:0;box-sizing:border-box}
  ...
  <div class="card">
    ...
    <div class="meta"><span class="badge">${esc(r.grade)}</span><span class="url">${esc(d.url ? prettyUrl(d.url) : d.host)}</span></div>
